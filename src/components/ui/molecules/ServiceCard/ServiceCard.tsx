...
export const ServiceCard = ({ title, description, included, optional }: ServiceCardProps) => {
    return (
        <div className='flex flex-col gap-6 bg-ui-background-primary p-8 lg:p-10 h-full'>
            ...
            <ul className='flex flex-col gap-2 border-t border-neutral-800 pt-6 mt-auto'>
